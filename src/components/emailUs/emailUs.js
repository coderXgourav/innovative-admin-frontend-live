...
function EmailUsManagement() {
    ...
    const handleCreate = async () => {
        ...
        const createdData = await createEmailUs(emailUsData);
        ...
        if (
            ...
            alert("email us created successfully")
            window.location.reload();
        }
    };
    ...
    const handleUpdate = async () => {
        ...
        const updatedData = await updateEmailUs(emailUsData);
        ...
        if (
            ...
            alert("email us updated successfully")
            window.location.reload();
        }
    };
    ...
    useEffect(() => {
        ...
        const fetcher = async () => {
            let tempEusData = await fetchEmailUs();

            if (tempEusData?.message === "jwt expired") {
                return navigate("/");
            } else {
    ...
    return (
        <>
            ...
            <div className="row">
                {windowWidth > 768 && <Sidebar activeOption="email-us-management" />}
                <div className="col-md-10 p-4" style={{ height: '90vh', overflowY: 'auto' }}>
                    ...
                    <div className="d-flex row">
                        <div className="col fw-bold">{`Email Us(${eus.length})`}</div>
...
export default EmailUsManagement;
